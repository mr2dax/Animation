...
<body>
<h1>Referencia hozzáadása</h1></br>
<form action="" method="POST">
<table border='0'><tr><td><input type="text" name="title" size="30" maxlength="32" /></td><td><textarea name="news" rows="10" cols="20"></textarea></td></tr>
<?php
	if ((isset($_POST["title"])) && (isset($_POST["news"]))) {
		...
		$result = "INSERT INTO ". $table . " (title, news) VALUES ('" . $title . "','" . $news . "')";
